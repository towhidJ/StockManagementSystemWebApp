<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanySetupUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.CompanyUI.CompanySetupUI" %>
            ...
            <table align="center">
                ...
                <div>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="textbox" ID="companyNameTextBox" runat="server" Width="132px"></asp:TextBox></td>
                    </tr>
                    <br />
                    <br />
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <asp:Button CssClass="Button" ID="showcompanyDetailsButton" runat="server" Text="Show Company" OnClick="showcompanyDetailsButton_OnClick" />
                        </td>
                    </tr>
                    <br />
                    <tr>
                        <td colspan="2">
                            <p style="color: red">
                                <asp:Label CssClass="textbox" ID="companyMessageLabel" runat="server"></asp:Label></p>
                        </td>
                    </tr>
                    <br />
