<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyUpdateUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.CompanyUI.CompanyUpdateUI" %>
            ...
            <table align="center">
                <div>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="textbox" ID="companyyNameTextBox" runat="server" Width="186px"></asp:TextBox></td>
                    </tr>
                    <br />
                    <br />
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <p style="color: red">
                                <asp:Label CssClass="textbox" ID="companyMessageLabel" runat="server"></asp:Label>
                            </p>
                        </td>
                    </tr>
                    <br />
