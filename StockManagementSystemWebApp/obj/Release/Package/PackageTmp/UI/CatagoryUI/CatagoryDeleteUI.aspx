<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatagoryDeleteUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.CatagoryUI.CtagoyDeleteUI" %>
            ...
            <div class="main">
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="textbox" ID="catagoryNameTextBox" runat="server" Width="132px" Enabled="False"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="right">
                            <asp:Button CssClass="Button" ID="deleteButton" runat="server" Text="Delete" OnClick="deleteButton_Click" />
                        </td>
                    </tr>
                    <tr>
