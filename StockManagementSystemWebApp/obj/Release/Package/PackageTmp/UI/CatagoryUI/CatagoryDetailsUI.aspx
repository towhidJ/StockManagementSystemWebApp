<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatagoryDetailsUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.CatagoryUI.CatagoryDetailsUI" %>
            ...
            <div>
                <table align="center">
                    <tr>
                        <td>
                            <div class="ItemDown">
                                <asp:GridView ID="catagoryGridView" runat="server" AutoGenerateColumns="False" Width="296px">
