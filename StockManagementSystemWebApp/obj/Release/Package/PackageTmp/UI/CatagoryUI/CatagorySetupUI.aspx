<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatagorySetupUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.CatagoryUI.CatagorySetupUI" %>
        ...
        <form id="form1" runat="server">
            <div class="main">
                <table align="center">
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <asp:Button CssClass="Button" ID="showDetailsButton" runat="server" Text="Show Catagory" OnClick="showDetailsButton_OnClick" />
                        </td>
                    </tr>
                    <br />
                    <tr>
                        <td colspan="2">
                            <p style="color: red">
                                <asp:Label CssClass="textbox" ID="catagoryMessageLabel" runat="server"></asp:Label></p>
                        </td>
                    </tr>
                    <br />
